...
US Dollar (DXY) & \(\sim\)99.7 & Firm, +1.8\% MoM & Headwind for commodities, Materials \\
...
Banks-plus-financials (12\% combined) is the largest active bet. Technology and real estate carry no satellite weight, held below benchmark via the core --- the funding source for the overweights. Blended dividend yield sits well above a pure-US benchmark; beta is near 1 with a value/defensive tilt.
...
Health care & iShares STOXX Europe 600 Health Care UCITS (DE) & EXV4 & confirm & \(\sim\)0.46\% & confirm \\
Energy & iShares STOXX Europe 600 Oil \& Gas UCITS (DE) & EXH1 & confirm & \(\sim\)0.47\% & confirm \\
Staples / food & iShares STOXX Europe 600 Food \& Beverage (DE) & confirm & confirm & \(\sim\)0.47\% & confirm \\
US financials & iShares S\&P 500 Financials Sector UCITS ETF & confirm & confirm & \(\sim\)0.15\% & confirm \\
\bottomrule
\end{tabularx}
\end{table}
...
\item \textbf{Dollar strength} --- hurts rare-earths/commodity exposure; but continued dollar weakness helps EUR returns, so two-sided.
