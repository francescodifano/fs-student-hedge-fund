...
LME warehouse stocks & 2,111.8 & kt [VERIFY unit] & +1.890 & +44.9 & +22.2\% & Ambiguous; tariff-distorted \\
...
\bottomrule
\end{tabularx}
\fshfsource{Ticker note: Yangshan used as CECN0002 (vs.\ planned YNSSPP); must reconcile before citing ticker in bibliography.}
\end{table}
...
\midrule
Brent level (USD/bbl) & Mean \$64.6; range \$58.9--\$72.5 & Peak \$118.3 (31 Mar); range \$77.7--\$118; last \$91.3 (9 Jun) & War +63\% peak vs pre-war; EIA cites \$138 intraday high 7 Apr \\
...
\item U.S. Energy Information Administration (EIA). (2026). Crude inventory data, Brent price references (\$138 intraday high, 7 April 2026), and price forecasts (Q4-2026 \(\sim\)\$89/bbl; 2027 \(\sim\)\$79/bbl). \url{https://www.eia.gov}
