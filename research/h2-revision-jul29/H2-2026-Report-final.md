...
**Hedge Fund Department, Frankfurt School of Finance and Management**
...
**Positioning period: July to December 2026**
**Published: July 2026**
...
**Three dates, and they are not the same.** The *reporting date* is 30 June 2026, the close of the first half. Every figure, position and portfolio statistic in Sections 1 to 8 is as of that date or, where a figure comes from one of the underlying papers, as of that paper's own analysis cut-off between 24 and 26 June 2026. The *publication date* is late July 2026. Material developments between the reporting date and publication are set out separately in Section 9, so that no reader mistakes them for part of the half-year record. The *positioning period* is July to December 2026, which is what the report is named for.

**Naming convention.** This report is named for the period it positions for, not for the period in which the research was produced. The next edition, built on the research written in the second half of 2026 and positioning for January to June 2027, will be the *H1 2027 Report*, with a reporting date of 31 December 2026.

**Two markers are used throughout.** Unmarked text is drawn from one of the fund's five research papers and can be traced back to them. Passages marked ***Fund view*** are consolidations or judgements made by the Hedge Fund Department rather than statements taken one to one from a paper. We use that marker where teams reach different conclusions, where the papers are silent on something a reader needs, or where the fund has closed an item the papers left open.

**One number is set outside the research process.** The weight of each sleeve within the total book is a decision of the Head of Fund rather than of the investment teams, and it is entered at final sign-off. Section 3.1 carries the table it goes into.

A short glossary for readers earlier in their studies is in Appendix D. Technical terms are also explained briefly where they first appear.

---

## Foreword: Letter from the Hedge Fund Department
...
| 31 March | approximately $118 to $119 | War peak. The commodities team mark $118.3, the equities team cite "near $119" |
| 7 April | $138 intraday | Cited by the EIA as a higher external reference. The fund's fair-value work anchors on the $118 figure |
...
At the half-year the US 10-year Treasury yield sat near 4.54%, the 2-year near 4.13%, and the 2s10s curve slope at plus 0.38%, a re-steepened curve that matters for bank net interest margins. The euro-area AAA-rated 10-year government bond yield was 2.92% on 26 June. The dollar index traded near 100. Despite the hawkish backdrop, financial conditions remained comparatively benign, with US high-yield credit spreads compressed near 2.7 percentage points, well below crisis levels.
...
## Section 9: Events After the Reporting Date
...
## Section 10: Outlook for H2 2026
...
|---|---|---|
| **1. Valuation** | PASS as a probe, Brent near $77.5, inside the $75 to $82 band | **FAIL.** Brent near $87, above the probe band and far above the $65 to $75 high-conviction zone |
...
At $87 the framework says do not chase, and that instruction is the one that protects capital over a full cycle. It is being followed.
...
## Section 11: Conclusion: The Book in One Page
...
| Four equity instrument lines marked "confirm" | Open. Exact ISIN and listing confirmation required in Interactive Brokers before deployment |
...
| Copper LME warehouse stocks unit | Open. Printed as 2,111.8 with the unit flagged. Published LME stocks sit near 300,000 to 320,000 tonnes |
...
| Sleeve weights within the total book | **Pending final sign-off, not an omission.** Decided by the Head of Fund and inserted into the table in Section 3.1 as the last content step before formatting |

## Appendix C: Data Conventions
